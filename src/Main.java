...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Node n6 = new Node (false, p6, new BigInteger("7000"));
        Node n5 = new Node (true, p5, new BigInteger("7001"));
        Node n4 = new Node (true, p4, new BigInteger("7002"));
        Node n3 = new Node (true, p3, new BigInteger("7003"));
        Node n2 = new Node(true, p2,  new BigInteger("7004"));
        Node n1 = new Node (true, p1,  new BigInteger("7005"));
